...
CREATE TABLE "race_results" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "race_results_race_id_unique" UNIQUE("race_id"),
	CONSTRAINT "race_results_id_race_id_unique" UNIQUE("id","race_id")
);
--> statement-breakpoint
...
ALTER TABLE "race_entries" ADD CONSTRAINT "race_entries_id_race_id_unique" UNIQUE("id","race_id");
ALTER TABLE "race_result_entries" ADD CONSTRAINT "race_result_entries_entry_race_fk" FOREIGN KEY ("entry_id","race_id") REFERENCES "public"."race_entries"("id","race_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "race_result_entries" ADD CONSTRAINT "race_result_entries_result_race_fk" FOREIGN KEY ("result_id","race_id") REFERENCES "public"."race_results"("id","race_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "violations" DROP COLUMN "race_id";--> statement-breakpoint
